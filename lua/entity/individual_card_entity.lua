...
local IndividualCardEntity = {}
IndividualCardEntity.__index = IndividualCardEntity


function IndividualCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IndividualCardEntity)
  self._name = "individual_card"
  self._client = client
...
function IndividualCardEntity:get_name()
  return self._name
end


function IndividualCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IndividualCardEntity.new(self._client, opts)
end
...
function IndividualCardEntity:mark_deleted()
  self._deleted = true
end


function IndividualCardEntity:deleted()
  return true == self._deleted
end


function IndividualCardEntity:data_set(args)
  if args ~= nil then
...
function IndividualCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IndividualCardEntity:match_set(args)
  if args ~= nil then
...
function IndividualCardEntity:match_get()
...
function IndividualCardEntity:stream(action, args, callopts)
...
---@param reqmatch IndividualCardLoadMatch
---@param ctrl? table
---@return IndividualCard
---@return string? err
function IndividualCardEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IndividualCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
