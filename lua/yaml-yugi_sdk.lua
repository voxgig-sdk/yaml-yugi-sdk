...
local YamlYugiSDK = {}
YamlYugiSDK.__index = YamlYugiSDK
...
YamlYugiSDK._make_feature = _make_feature


function YamlYugiSDK.new(options)
  local self = setmetatable({}, YamlYugiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function YamlYugiSDK:options_map()
...
function YamlYugiSDK:get_utility()
  return Utility.copy(self._utility)
end


function YamlYugiSDK:get_root_ctx()
  return self._rootctx
end


function YamlYugiSDK:prepare(fetchargs)
...
function YamlYugiSDK:direct(fetchargs)
...
-- by passing it.
function YamlYugiSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function YamlYugiSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "YamlYugiSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function YamlYugiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = YamlYugiSDK.new(sdkopts)
  sdk.mode = "test"
