-- SeriesAndArchetype direct test
...
describe("SeriesAndArchetypeDirect", function()
  it("should direct-load-series_and_archetype", function()
    local setup = series_and_archetype_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-series_and_archetype", setup.live and "live" or "unit")
...
function series_and_archetype_direct_setup(mockres)
