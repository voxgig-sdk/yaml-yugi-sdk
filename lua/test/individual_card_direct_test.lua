...
describe("IndividualCardDirect", function()
  it("should direct-load-individual_card", function()
    local setup = individual_card_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-individual_card", setup.live and "live" or "unit")
...
function individual_card_direct_setup(mockres)
