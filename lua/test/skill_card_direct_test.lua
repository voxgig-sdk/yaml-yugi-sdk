...
describe("SkillCardDirect", function()
  it("should direct-load-skill_card", function()
    local setup = skill_card_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-skill_card", setup.live and "live" or "unit")
...
function skill_card_direct_setup(mockres)
