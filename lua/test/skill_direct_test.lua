...
describe("SkillDirect", function()
  it("should direct-list-skill", function()
    local setup = skill_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-skill", setup.live and "live" or "unit")
...
function skill_direct_setup(mockres)
