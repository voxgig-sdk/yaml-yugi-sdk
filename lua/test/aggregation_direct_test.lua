...
describe("AggregationDirect", function()
  it("should direct-load-aggregation", function()
    local setup = aggregation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-aggregation", setup.live and "live" or "unit")
...
function aggregation_direct_setup(mockres)
