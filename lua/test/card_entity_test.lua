...
describe("CardEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YAMLYUGI_TEST_CARD_ENTID JSON to run live")
      return
    end
...
function card_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YAMLYUGI_TEST_CARD_ENTID")
