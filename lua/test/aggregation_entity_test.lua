...
describe("AggregationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YAML_YUGI_TEST_AGGREGATION_ENTID JSON to run live")
      return
    end
...
function aggregation_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YAML_YUGI_TEST_AGGREGATION_ENTID")
