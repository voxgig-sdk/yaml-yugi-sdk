...
class SeriesAndArchetypeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YAML_YUGI_TEST_SERIES_AND_ARCHETYPE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function series_and_archetype_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YAML_YUGI_TEST_SERIES_AND_ARCHETYPE_ENTID");
