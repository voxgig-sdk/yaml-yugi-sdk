...
// YamlYugi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YamlYugiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YamlYugiOmni::structfix($now, Struct::undef()))
                        !== json_encode(YamlYugiOmni::structfix($val, Struct::undef()))) {
