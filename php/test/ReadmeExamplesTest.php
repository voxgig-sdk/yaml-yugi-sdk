...
// YamlYugi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YamlYugiSDK::test)
...
{
    private const SDK_CLASS = 'YamlYugiSDK';
    ...
    private const SDK_BASE = 'yamlyugi_sdk';
