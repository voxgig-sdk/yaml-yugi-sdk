...
class SkillDirectTest extends TestCase
{
    public function test_direct_list_skill(): void
    {
        $setup = skill_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-skill", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
