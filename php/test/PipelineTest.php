...
{
    private static function utility(): YamlYugiUtility
    {
        return new YamlYugiUtility();
    }
    ...
    private static function ctx(array $over = []): YamlYugiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YamlYugiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YamlYugiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YamlYugiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YamlYugiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YamlYugiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YamlYugiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YamlYugiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YamlYugiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YamlYugiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YamlYugiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YamlYugiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new YamlYugiResponse([]),
            'result' => new YamlYugiResult([]),
        ]);
        [, $err] = YamlYugiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new YamlYugiSpec([]),
            'response' => null,
            'result' => new YamlYugiResult([]),
        ]);
        [, $err] = YamlYugiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YamlYugiSpec(['step' => 's']),
            'response' => new YamlYugiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YamlYugiResult([]),
        ]);
        [, $err] = YamlYugiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YamlYugiSpec(['step' => 's']),
            'response' => new YamlYugiResponse(self::resp(200, ['v' => 1])),
            'result' => new YamlYugiResult([]),
        ]);
        [, $err] = YamlYugiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YamlYugiSpec(['step' => 's']),
            'response' => new YamlYugiResponse(self::resp(200, ['v' => 2])),
            'result' => new YamlYugiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YamlYugiMakeResponse::call($ctx);
    ...
    {
        $preset = new YamlYugiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YamlYugiSpec([]),
            'response' => new YamlYugiResponse([]),
            'result' => new YamlYugiResult([]),
        ...
        [$got, $err] = YamlYugiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YamlYugiResult([])]);
        [, $err] = YamlYugiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YamlYugiSpec([]), 'result' => null]);
        [, $err] = YamlYugiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YamlYugiSpec(['step' => 's']),
            'result' => new YamlYugiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YamlYugiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YamlYugiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YamlYugiSpec(['step' => 's']),
            'result' => new YamlYugiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YamlYugiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YamlYugiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YamlYugiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YamlYugiSpec([]),
            'result' => new YamlYugiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YamlYugiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YamlYugiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YamlYugiError('boom', 'boom');
        $utility->fetcher = function (YamlYugiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YamlYugiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YamlYugiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YamlYugiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YamlYugiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YamlYugiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YamlYugiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YamlYugiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YamlYugiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YamlYugiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YamlYugiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YamlYugiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YamlYugiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YamlYugiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YamlYugiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YamlYugiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YamlYugiResult(['ok' => false])]);
        $this->expectException(YamlYugiError::class);
        YamlYugiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YamlYugiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YamlYugiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        YamlYugiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YamlYugiBaseFeature();
        $b = new YamlYugiBaseFeature();
        YamlYugiFeatureAdd::call($ctx, $a);
        YamlYugiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YamlYugiBaseFeature
    {
        $f = new YamlYugiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YamlYugiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YamlYugiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YamlYugiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YamlYugiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YamlYugiResponse(['headers' => null]),
            'result' => new YamlYugiResult([]),
        ]);
        YamlYugiResultHeaders::call($ctx);
