...
class CardEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YAMLYUGI_TEST_CARD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function card_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YAMLYUGI_TEST_CARD_ENTID");
