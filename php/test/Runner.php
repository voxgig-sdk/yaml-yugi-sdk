...
class YamlYugiTestRunner
{
    ...
    {
        $live = self::getenv('YAML_YUGI_TEST_LIVE');
        $override = self::getenv('YAML_YUGI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('YAML_YUGI_TEST_EXPLAIN');
...
class_alias('YamlYugiTestRunner', 'Runner');
class_alias('YamlYugiHelpers', 'Helpers');
