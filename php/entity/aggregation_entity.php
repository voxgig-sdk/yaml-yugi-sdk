...
// YamlYugi SDK Aggregation entity
...
class AggregationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AggregationEntity($this->_client, $opts);
    }

    /**
     * @param Aggregation|array $args Aggregation data (assoc-array) to store.
     */
    ...
    /**
     * @return Aggregation|array The current Aggregation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Aggregation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Aggregation fields).
     */
     ...
     *
     * @param AggregationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AggregationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Aggregation|array The loaded Aggregation as an assoc-array at the
