...
class SkillCardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SkillCardEntity($this->_client, $opts);
    }

    /**
     * @param SkillCard|array $args SkillCard data (assoc-array) to store.
     */
    ...
    /**
     * @return SkillCard|array The current SkillCard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SkillCard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SkillCard fields).
     */
    ...
    /**
     * Load a single SkillCard.
     *
     * @param SkillCardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SkillCardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SkillCard|array The loaded SkillCard as an assoc-array at the
