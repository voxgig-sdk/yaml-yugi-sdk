...
The PHP SDK for the YamlYugi API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Aggregation(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->YamlYugi(null)->load(
    ["id" => "test01"], null
);
