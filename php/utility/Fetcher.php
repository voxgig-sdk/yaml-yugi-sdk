...
// YamlYugi SDK utility: fetcher

class YamlYugiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YamlYugiSDK/1.0)';
    ...
    public static function call(YamlYugiContext $ctx, string $fullurl, array $fetchdef): array
    {
