...
class YamlYugiGraphql
{
    ...
    // equivalent.
    public static function body(YamlYugiContext $ctx): mixed
    {
    ...
    public static function errors(YamlYugiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
