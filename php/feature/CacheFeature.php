...
class YamlYugiCacheFeature extends YamlYugiBaseFeature
{
    ...
    private function _through(YamlYugiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
