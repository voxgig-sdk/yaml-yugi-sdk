...
// YamlYugi SDK ratelimit feature
...
class YamlYugiRatelimitFeature extends YamlYugiBaseFeature
{
    ...
    private function _acquire(YamlYugiContext $ctx): void
    {
    ...
    private function _track(YamlYugiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
