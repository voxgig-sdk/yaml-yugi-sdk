...
from yamlyugi_sdk.core.spec import YamlYugiSpec
from yamlyugi_sdk.core.result import YamlYugiResult
from yamlyugi_sdk.core.response import YamlYugiResponse
from yamlyugi_sdk.core.operation import YamlYugiOperation
from yamlyugi_sdk.core.error import YamlYugiError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = YamlYugiSDK.test(None, None)
        ...
        class TestInitFeature(YamlYugiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(YamlYugiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = YamlYugiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = YamlYugiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = YamlYugiSDK.test(None, setup_opts)
