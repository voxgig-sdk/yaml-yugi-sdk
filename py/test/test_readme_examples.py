# YamlYugi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YamlYugiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YamlYugiSDK(...) and YamlYugiSDK.test(...) become
#      YamlYugiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yamlyugi_sdk"
_SDK_CLASS = "YamlYugiSDK"
