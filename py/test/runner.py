...
class YamlYugiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YamlYugiTestRunner.getenv("YAMLYUGI_TEST_LIVE")
        override = YamlYugiTestRunner.getenv("YAMLYUGI_TEST_OVERRIDE")
        ...
        explain = YamlYugiTestRunner.getenv("YAMLYUGI_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["YAMLYUGI_TEST_EXPLAIN"] = explain
