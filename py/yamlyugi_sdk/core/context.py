...
from yamlyugi_sdk.core.control import YamlYugiControl
...
from yamlyugi_sdk.core.helpers import get_ctx_prop, to_map
...
class YamlYugiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, YamlYugiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YamlYugiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return YamlYugiError(code, msg, self)
