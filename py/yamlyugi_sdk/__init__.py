...
from yamlyugi_sdk.utility import register

# Load features
from yamlyugi_sdk.feature.base_feature import YamlYugiBaseFeature
from yamlyugi_sdk.features import _has_feature, _make_feature
...
class YamlYugiSDK:
    ...
    def get_utility(self):
        return YamlYugiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YamlYugiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Aggregation(self, data=None) -> "AggregationEntity":
        ...
        from yamlyugi_sdk.entity.aggregation_entity import AggregationEntity
        return AggregationEntity(self, data)


    def Card(self, data=None) -> "CardEntity":
        """Entity factory: client.Card().list() / client.Card().load({"id": ...})."""
        from yamlyugi_sdk.entity.card_entity import CardEntity
    ...
    def IndividualCard(self, data=None) -> "IndividualCardEntity":
        ...
        from yamlyugi_sdk.entity.individual_card_entity import IndividualCardEntity
