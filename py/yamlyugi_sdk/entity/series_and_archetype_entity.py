...
class SeriesAndArchetypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SeriesAndArchetypeEntity(self._client, opts)
    ...
    def data_get(self) -> SeriesAndArchetype:
    ...
    def match_get(self) -> SeriesAndArchetype:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SeriesAndArchetype:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SeriesAndArchetype().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
