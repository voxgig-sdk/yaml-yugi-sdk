...
from yamlyugi_sdk.yamlyugi_types import (
    IndividualCard,
...
class IndividualCardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IndividualCardEntity(self._client, opts)
    ...
    def data_get(self) -> IndividualCard:
    ...
    def match_get(self) -> IndividualCard:
    ...
    def load(self, reqmatch=None, ctrl=None) -> IndividualCard:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.IndividualCard().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
