...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/yaml-yugi` | `npm install @voxgig-sdk/yaml-yugi` |
| Python | `voxgig-sdk-yaml-yugi` | `pip install voxgig-sdk-yaml-yugi` |
| PHP | `voxgig-sdk/yaml-yugi` | `composer require voxgig-sdk/yaml-yugi` |
| Golang | `github.com/voxgig-sdk/yaml-yugi-sdk/go` | `go get github.com/voxgig-sdk/yaml-yugi-sdk/go` |
| Ruby | `voxgig-sdk-yaml-yugi` | `gem install voxgig-sdk-yaml-yugi` |
| Lua | `voxgig-sdk-yaml-yugi` | `luarocks install voxgig-sdk-yaml-yugi` |
