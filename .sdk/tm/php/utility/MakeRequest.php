...
// YamlYugi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YamlYugiMakeRequest
{
    public static function call(YamlYugiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YamlYugiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YamlYugiResponse($fetched);
        } else {
