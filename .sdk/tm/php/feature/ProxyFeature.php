...
class YamlYugiProxyFeature extends YamlYugiBaseFeature
{
    ...
    public function init(YamlYugiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YamlYugiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
