...
class YamlYugiRbacFeature extends YamlYugiBaseFeature
{
    ...
    private function _required(YamlYugiContext $ctx): ?string
    {
    ...
    private function _reject(YamlYugiContext $ctx, string $required): void
    {
    ...
    private function _track(YamlYugiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
