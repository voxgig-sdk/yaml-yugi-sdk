...
// YamlYugi SDK streaming feature
...
class YamlYugiStreamingFeature extends YamlYugiBaseFeature
{
    ...
    private function _iterate(YamlYugiResult $result): \Generator
    {
    ...
    private function _streamable(YamlYugiContext $ctx): bool
    {
