...
class YamlYugiTimeoutFeature extends YamlYugiBaseFeature
{
    ...
    private function _with_timeout(YamlYugiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YamlYugiContext $_ctx, float $ms): void
    {
        $client = $this->client;
