...
// YamlYugi SDK clienttrack feature
...
class YamlYugiClienttrackFeature extends YamlYugiBaseFeature
{
    ...
    public function PostConstruct(YamlYugiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YamlYugi-SDK';
