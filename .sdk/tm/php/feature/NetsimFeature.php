...
class YamlYugiNetsimFeature extends YamlYugiBaseFeature
{
    ...
    private function _simulate(YamlYugiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YamlYugiContext $ctx, array $applied): void
    {
        $client = $this->client;
