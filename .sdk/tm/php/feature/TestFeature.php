...
// YamlYugi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class YamlYugiTestFeature extends YamlYugiBaseFeature
{
    ...
    public function init(YamlYugiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (YamlYugiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (YamlYugiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(YamlYugiContext $ctx, $op, $args): array
    {
