...
|---|---|---|
| `ts/` | @voxgig-sdk/yaml-yugi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yaml-yugi-sdk \
      --repository voxgig-sdk/yaml-yugi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yaml-yugi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yaml-yugi-sdk --id=<id>` removes it.
