...
class SkillEntity
  ...
  # @return [Skill, Hash] the current Skill data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Skill fields)
  def match_get
  ...
  #
  # @param reqmatch [SkillListMatch, Hash, nil] match filter (any subset of
  #   Skill fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Skill>, Array] the matching Skill items; raises YamlYugiError on failure
