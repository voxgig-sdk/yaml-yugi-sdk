...
class CardEntity
  ...
  #
  # @param reqmatch [CardListMatch, Hash, nil] match filter (any subset of
  #   Card fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Card>, Array] the matching Card items; raises YamlYugiError on failure
