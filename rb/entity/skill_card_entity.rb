...
class SkillCardEntity
  ...
  def make
    opts = @_entopts.dup
    SkillCardEntity.new(@_client, opts)
  end
  ...
  # @return [SkillCard, Hash] the current SkillCard data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SkillCard fields)
  def match_get
  ...
  #
  # @param reqmatch [SkillCardLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.SkillCard.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [SkillCard, Hash] the loaded SkillCard; raises YamlYugiError on failure
