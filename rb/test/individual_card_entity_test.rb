...
class IndividualCardEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YAML_YUGI_TEST_INDIVIDUAL_CARD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def individual_card_basic_setup(extra)
  ...
  entid_env_raw = ENV["YAML_YUGI_TEST_INDIVIDUAL_CARD_ENTID"]
