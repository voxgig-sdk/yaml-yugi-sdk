...
class AggregationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YAML_YUGI_TEST_AGGREGATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def aggregation_basic_setup(extra)
  ...
  entid_env_raw = ENV["YAML_YUGI_TEST_AGGREGATION_ENTID"]
