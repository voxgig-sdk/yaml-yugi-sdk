...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = YamlYugiOmni.make_runner(TEST_JSON_FILE, YamlYugiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : YamlYugiOmni.errify(err)
    end
