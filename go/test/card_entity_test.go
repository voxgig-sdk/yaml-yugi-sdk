...
func TestCardEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set YAMLYUGI_TEST_CARD_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func cardBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("YAMLYUGI_TEST_CARD_ENTID")
	...
	idmapResolved := core.ToMapAny(env["YAMLYUGI_TEST_CARD_ENTID"])
