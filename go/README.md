...
## Install
```bash
go get github.com/voxgig-sdk/yaml-yugi-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/yaml-yugi-sdk=../path/to/github.com/voxgig-sdk/yaml-yugi-sdk
```
...
```
github.com/voxgig-sdk/yaml-yugi-sdk/
...
The root package (`github.com/voxgig-sdk/yaml-yugi-sdk`) re-exports everything needed
