...
type IndividualCardEntity struct {
	name    string
...
func NewIndividualCardEntity(client *core.YamlYugiSDK, entopts map[string]any) *IndividualCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IndividualCardEntity) GetName() string { return e.name }
...
func (e *IndividualCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IndividualCardEntity) Deleted() bool {
	return e.deleted
}


func (e *IndividualCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIndividualCardEntity(e.client, opts)
}

func (e *IndividualCardEntity) Data(args ...any) any {
...
func (e *IndividualCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IndividualCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IndividualCardEntity) DataTyped(data ...IndividualCard) IndividualCard {
	if len(data) > 0 {
		return typedFrom[IndividualCard](e.Data(asMap(data[0])))
	}
	return typedFrom[IndividualCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IndividualCard (all fields
// optional at the wire level).
func (e *IndividualCardEntity) MatchTyped(match ...IndividualCard) IndividualCard {
	if len(match) > 0 {
		return typedFrom[IndividualCard](e.Match(asMap(match[0])))
	}
	return typedFrom[IndividualCard](e.Match())
}
...
func (e *IndividualCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IndividualCardEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IndividualCardLoadMatch and returns an IndividualCard. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IndividualCardEntity) LoadTyped(reqmatch IndividualCardLoadMatch, ctrl map[string]any) (IndividualCard, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IndividualCard{}, err
	}
	return typedFrom[IndividualCard](res), nil
}



func (e *IndividualCardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IndividualCardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IndividualCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IndividualCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IndividualCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
