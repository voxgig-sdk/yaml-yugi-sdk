...
type SeriesAndArchetypeEntity struct {
	name    string
...
func NewSeriesAndArchetypeEntity(client *core.YamlYugiSDK, entopts map[string]any) *SeriesAndArchetypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SeriesAndArchetypeEntity) GetName() string { return e.name }
...
func (e *SeriesAndArchetypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SeriesAndArchetypeEntity) Deleted() bool {
	return e.deleted
}


func (e *SeriesAndArchetypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSeriesAndArchetypeEntity(e.client, opts)
}

func (e *SeriesAndArchetypeEntity) Data(args ...any) any {
...
func (e *SeriesAndArchetypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SeriesAndArchetype; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SeriesAndArchetypeEntity) DataTyped(data ...SeriesAndArchetype) SeriesAndArchetype {
	if len(data) > 0 {
		return typedFrom[SeriesAndArchetype](e.Data(asMap(data[0])))
	}
	return typedFrom[SeriesAndArchetype](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SeriesAndArchetype (all fields
// optional at the wire level).
func (e *SeriesAndArchetypeEntity) MatchTyped(match ...SeriesAndArchetype) SeriesAndArchetype {
	if len(match) > 0 {
		return typedFrom[SeriesAndArchetype](e.Match(asMap(match[0])))
	}
	return typedFrom[SeriesAndArchetype](e.Match())
}
...
func (e *SeriesAndArchetypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SeriesAndArchetypeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SeriesAndArchetypeLoadMatch and returns an SeriesAndArchetype. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SeriesAndArchetypeEntity) LoadTyped(reqmatch SeriesAndArchetypeLoadMatch, ctrl map[string]any) (SeriesAndArchetype, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SeriesAndArchetype{}, err
	}
	return typedFrom[SeriesAndArchetype](res), nil
}



func (e *SeriesAndArchetypeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SeriesAndArchetypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SeriesAndArchetypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SeriesAndArchetypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SeriesAndArchetypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
