...
func NewAggregationEntity(client *core.YamlYugiSDK, entopts map[string]any) *AggregationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AggregationEntity) GetName() string { return e.name }
...
func (e *AggregationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AggregationEntity) Deleted() bool {
	return e.deleted
}


func (e *AggregationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAggregationEntity(e.client, opts)
}

func (e *AggregationEntity) Data(args ...any) any {
...
func (e *AggregationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AggregationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AggregationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AggregationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AggregationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AggregationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AggregationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
