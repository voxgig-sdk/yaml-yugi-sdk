...
func NewCardEntity(client *core.YamlYugiSDK, entopts map[string]any) *CardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *CardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
