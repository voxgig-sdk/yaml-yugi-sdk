...
exports.SkillCardEntity = void 0;
const YamlYugiEntityBase_1 = require("../YamlYugiEntityBase");
// TODO: needs Entity superclass
class SkillCardEntity extends YamlYugiEntityBase_1.YamlYugiEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'skill_card';
        this.name_ = 'skill_card';
        this.Name = 'SkillCard';
    }
    make() {
        return new SkillCardEntity(this._client, this.entopts());
    }
...
exports.SkillCardEntity = SkillCardEntity;
//# sourceMappingURL=SkillCardEntity.js.map