...
describe('SkillDirect', async () => {
  ...
  test('direct-list-skill', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-skill', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YAML_YUGI_TEST_SKILL_ENTID']
