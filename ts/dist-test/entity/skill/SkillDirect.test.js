...
(0, node_test_1.describe)('SkillDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-skill', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-skill', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YAML_YUGI_TEST_SKILL_ENTID'];
...
//# sourceMappingURL=SkillDirect.test.js.map