...
(0, node_test_1.describe)('CardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-card', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-card', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["card01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YAML_YUGI_TEST_CARD_ENTID'];
