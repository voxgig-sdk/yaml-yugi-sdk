...
(0, node_test_1.describe)('SeriesAndArchetypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-series_and_archetype', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-series_and_archetype', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YAML_YUGI_TEST_SERIES_AND_ARCHETYPE_ENTID'];
...
//# sourceMappingURL=SeriesAndArchetypeDirect.test.js.map