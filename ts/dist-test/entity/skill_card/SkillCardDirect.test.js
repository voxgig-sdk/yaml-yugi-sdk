...
(0, node_test_1.describe)('SkillCardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-skill_card', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-skill_card', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YAML_YUGI_TEST_SKILL_CARD_ENTID'];
...
//# sourceMappingURL=SkillCardDirect.test.js.map