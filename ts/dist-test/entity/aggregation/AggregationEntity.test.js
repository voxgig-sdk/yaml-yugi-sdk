...
(0, node_test_1.describe)('AggregationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'aggregation.' + op, live))
                return;
        }
        ...
        let aggregation_ref01_data = Object.values(setup.data.existing.aggregation)[0];
        // LOAD
        const aggregation_ref01_ent = client.Aggregation();
        const aggregation_ref01_match_dt0 = {};
        const aggregation_ref01_data_dt0 = (await aggregation_ref01_ent.load(aggregation_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != aggregation_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/aggregation/AggregationTestData.json');
    ...
    let idmap = transform(['aggregation01', 'aggregation02', 'aggregation03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AggregationEntity.test.js.map