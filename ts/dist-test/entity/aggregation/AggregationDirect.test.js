...
(0, node_test_1.describe)('AggregationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-aggregation', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-aggregation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['YAML_YUGI_TEST_AGGREGATION_ENTID'];
...
//# sourceMappingURL=AggregationDirect.test.js.map