...
(0, node_test_1.describe)('IndividualCardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-individual_card', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-individual_card', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'YAML_YUGI_TEST_INDIVIDUAL_CARD_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.YamlYugiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['YAML_YUGI_TEST_INDIVIDUAL_CARD_ENTID'];
    ...
    const client = new __1.YamlYugiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IndividualCardDirect.test.js.map