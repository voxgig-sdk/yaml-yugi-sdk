...
function envOverride(m) {
    if ('TRUE' === process.env.YAML_YUGI_TEST_LIVE ||
        'TRUE' === process.env.YAML_YUGI_TEST_OVERRIDE) {
    ...
    m.YAML_YUGI_TEST_EXPLAIN = process.env.YAML_YUGI_TEST_EXPLAIN || m.YAML_YUGI_TEST_EXPLAIN;
    return m;
}
